    ...
    <div className="w-full pt-[24px] md:pt-[28px] xl:pt-[34px] px-5 md:px-[40px] lg:px-[60px] xl:px-[100px] 2xl:px-[120px]">
      <div className="w-full max-w-[1920px] mx-auto flex items-center justify-between">
        ...
        <div className="login-header-buttons">
          <Link
            href="#"
            className="text-[15px] md:text-[16px] xl:text-[20px] leading-normal text-black tracking-[0.4px] mr-3 md:mr-[24px] xl:mr-[32px] "
          >
            Looking for work?
          </Link>
          <Link
            href="#"
            className="text-[#005AFF] text-[15px] md:text-[16px] xl:text-[20px] leading-normal tracking-[0.4px]"
          >
            Apply as talent
          </Link>
        </div>
