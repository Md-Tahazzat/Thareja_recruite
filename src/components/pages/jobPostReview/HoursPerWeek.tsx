...
const HoursPerWeek = () => {
  ...
  return (
    <div className="w-full 2xl:mb-5 lg:ml-auto 2xl:max-w-[313px] py-4 px-5 2xl:py-[20px] 2xl:px-[28px] bg-white border border-[#005aff1a] rounded-[12px]">
      <h4 className="jobpost-details-label">Hours per week</h4>
      <ul>
        {data.map((item) => (
          <li
