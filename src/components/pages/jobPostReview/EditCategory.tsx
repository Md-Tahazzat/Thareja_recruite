    ...
    <div className=" w-full max-w-[776px] max-h-[95%] min-h-[250px] py-[20px] h-full md:h-auto rounded-[20px] md:rounded-[30px] bg-white shadow-md ">
      <div className="overflow-y-auto relative px-[20px] md:px-[50px] md:pl-[32px] md:py-[30px] max-h-[100%] w-full h-full">
        ...
        <div className="w-full mb-[30px] md:mb-[50px] 2xl:mb-[72px]">
          <h4 className="mb-[10px] text-[18px] md:text-[20px] leading-normal tracking-[0.4px]">
            Category
          </h4>
          <CategoryDropdown handler={handleSelectCategory} />

          <h4 className="mt-[28px] mb-[10px] text-[18px] md:text-[20px] leading-normal tracking-[0.4px]">
            Specialty
          </h4>
