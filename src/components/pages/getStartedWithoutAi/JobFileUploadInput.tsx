...
const JobFileUploadInput = () => {
  ...
  return (
    <div className="relative">
      <h4 className="text-[18px] md:text-[20px] leading-normal tracking-[0.4px]">
        Need help?
      </h4>
      ...
      <button
        ...
        className="text-[#005AFF] text-[18px] md:text-[20px] cursor-pointer py-5 block"
      >
      ...
      <p className="block pt-[14px] font-[300] text-[18px] leading-[25px]">
        {" "}
